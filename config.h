...
static const char *fonts[]          = { "Hack Nerd Font Mono:size=16", "Noto Color Emoji:size=14" };
...
static Key keys[] = {
	...
	{ MODKEY|Mod4Mask,              XK_u,      focusstackhid,  {.i = +1 } },
	{ MODKEY|Mod4Mask,              XK_e,      focusstackhid,  {.i = -1 } },
